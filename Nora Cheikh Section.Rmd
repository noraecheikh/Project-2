...
Partition the cleantraining data into two sections: 70% for training the model and 30% to test how well the model predicts
```{r}
...
To evaluate how well this model is at predicting the classe classifications, I used the 
```{r}
